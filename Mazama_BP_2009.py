...
def main():
  ...
  # NOTE:  BP doesn't keep the old reports around so I grabbed 2002-2009 from ASPO at this URL:
  # NOTE:    http://www.tsl.uu.se/uhdsg/Data/
  stat_review = 'BP_2009.xls'
  ...
  oil_production = open('BP_2009_oil_production_bbl.csv','w')
  ...
  oil_production.write("title         = ASCII CSV version of Oil Production data from the 2009 British Petroleum Statistical Review (worksheet 4)\n")
  oil_production.write("file URL      = http://mazamascience.com/OilExport/BP_2009_oil_production.csv\n")
  oil_production.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  ...
  oil_production = open('BP_2009_oil_production_mtoe.csv','w')
  ...
  oil_production.write("title         = ASCII CSV version of Oil Production data from the 2009 British Petroleum Statistical Review (worksheet 5)\n")
  oil_production.write("file URL      = http://mazamascience.com/OilExport/BP_2009_oil_production_mtoe.csv\n")
  oil_production.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  oil_production.write("country codes = ISO3166-1 two-letter codes or 'BP_~~~' for special groups (e.g. BP_TNA = Total North America)\n")
  ...
  oil_consumption = open('BP_2009_oil_consumption_bbl.csv','w')
  ...
  rowrange = years + NAm + SAm + Europe + ME + Africa + Asia + Special
  colrange = range(1,45)
  oil_consumption.write("title         = ASCII CSV version of Oil consumption data from the 2009 British Petroleum Statistical Review (worksheet 6)\n")
  oil_consumption.write("file URL      = http://mazamascience.com/OilExport/BP_2009_oil_consumption_bbl.csv\n")
  oil_consumption.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  ...
  oil_consumption = open('BP_2009_oil_consumption_mtoe.csv','w')
  ...
  rowrange = years + NAm + SAm + Europe + ME + Africa + Asia + Special
  colrange = range(1,45)
  oil_consumption.write("title         = ASCII CSV version of Oil consumption data from the 2009 British Petroleum Statistical Review (worksheet 7)\n")
  oil_consumption.write("file URL      = http://mazamascience.com/OilExport/BP_2009_oil_consumption_mtoe.csv\n")
  oil_consumption.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  oil_consumption.write("country codes = ISO3166-1 two-letter codes or 'BP_~~~' for special groups (e.g. BP_TNA = Total North America)\n")
  ...
  crude_prices = open('BP_2009_oil_crude_prices_since_1861.csv','w')
  ...
  # 109    1965
  # 152    2008
  rowrange = range(108,152)
  colrange = range(0,3)
  crude_prices.write("title            = ASCII CSV version of crude prices from the 2009 British Petroleum Statistical Review (worksheet 10, years 1965-2007 only)\n")
  crude_prices.write("file URL         = http://mazamascience.com/OilExport/BP_2009_oil_crude_prices_since_1861.csv\n")
  crude_prices.write("original data    = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  ...
  gas_production = open('BP_2009_gas_production_m3.csv','w')
  ...
  rowrange = years + NAm + SAm + Europe + ME + Africa + Asia + Special
  colrange = range(1,40)
  gas_production.write("title         = ASCII CSV version of Natural Gas production data from the 2009 British Petroleum Statistical Review (worksheet 19)\n")
  gas_production.write("file URL      = http://mazamascience.com/OilExport/BP_2009_gas_production_m3.csv\n")
  gas_production.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  ...
  gas_production = open('BP_2009_gas_production_ft3.csv','w')
  ...
  rowrange = years + NAm + SAm + Europe + ME + Africa + Asia + Special
  colrange = range(1,40)
  gas_production.write("title         = ASCII CSV version of Natural Gas production data from the 2009 British Petroleum Statistical Review (worksheet 20)\n")
  gas_production.write("file URL      = http://mazamascience.com/OilExport/BP_2009_gas_production_ft3.csv\n")
  gas_production.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  gas_production.write("country codes = ISO3166-1 two-letter codes or 'BP_~~~' for special groups (e.g. BP_TNA = Total North America)\n")
  ...
  gas_production = open('BP_2009_gas_production_mtoe.csv','w')
  ...
  rowrange = years + NAm + SAm + Europe + ME + Africa + Asia + Special
  colrange = range(1,40)
  gas_production.write("title         = ASCII CSV version of Natural Gas production data from the 2009 British Petroleum Statistical Review (worksheet 21)\n")
  gas_production.write("file URL      = http://mazamascience.com/OilExport/BP_2009_gas_production_mtoe.csv\n")
  gas_production.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  gas_production.write("country codes = ISO3166-1 two-letter codes or 'BP_~~~' for special groups (e.g. BP_TNA = Total North America)\n")
  ...
  gas_consumption = open('BP_2009_gas_consumption_m3.csv','w')
  ...
  rowrange = years + NAm + SAm + Europe + ME + Africa + Asia + Special
  colrange = range(1,45)
  gas_consumption.write("title         = ASCII CSV version of Natural Gas consumption data from the 2009 British Petroleum Statistical Review (worksheet 22)\n")
  gas_consumption.write("file URL      = http://mazamascience.com/OilExport/BP_2009_gas_consumption_m3.csv\n")
  gas_consumption.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  ...
  gas_consumption = open('BP_2009_gas_consumption_ft3.csv','w')
  ...
  rowrange = years + NAm + SAm + Europe + ME + Africa + Asia + Special
  colrange = range(1,45)
  gas_consumption.write("title         = ASCII CSV version of Natural Gas consumption data from the 2009 British Petroleum Statistical Review (worksheet 23)\n")
  gas_consumption.write("file URL      = http://mazamascience.com/OilExport/BP_2009_gas_consumption_ft3.csv\n")
  gas_consumption.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  gas_consumption.write("country codes = ISO3166-1 two-letter codes or 'BP_~~~' for special groups (e.g. BP_TNA = Total North America)\n")
  ...
  gas_consumption = open('BP_2009_gas_consumption_mtoe.csv','w')
  ...
  rowrange = years + NAm + SAm + Europe + ME + Africa + Asia + Special
  colrange = range(1,45)
  gas_consumption.write("title         = ASCII CSV version of Natural Gas consumption data from the 2009 British Petroleum Statistical Review (worksheet 24)\n")
  gas_consumption.write("file URL      = http://mazamascience.com/OilExport/BP_2009_gas_consumption_mtoe.csv\n")
  gas_consumption.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  gas_consumption.write("country codes = ISO3166-1 two-letter codes or 'BP_~~~' for special groups (e.g. BP_TNA = Total North America)\n")
  ...
  coal_production = open('BP_2009_coal_production_mtoe.csv','w')
  ...
  rowrange = years + NAm + SAm + Europe + ME + Africa + Asia + Special
  colrange = range(1,29)
  coal_production.write("title         = ASCII CSV version of Coal production data from the 2009 British Petroleum Statistical Review (worksheet 30)\n")
  coal_production.write("file URL      = http://mazamascience.com/OilExport/BP_2009_coal_production_mtoe.csv\n")
  coal_production.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  ...
  coal_consumption = open('BP_2009_coal_consumption_mtoe.csv','w')
  ...
  rowrange = years + NAm + SAm + Europe + ME + Africa + Asia + Special
  colrange = range(1,45)
  coal_consumption.write("title         = ASCII CSV version of Coal consumption data from the 2009 British Petroleum Statistical Review (worksheet 31)\n")
  coal_consumption.write("file URL      = http://mazamascience.com/OilExport/BP_2009_coal_consumption_mtoe.csv\n")
  coal_consumption.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  ...
  nuclear_consumption = open('BP_2009_nuclear_consumption_twh.csv','w')
  ...
  rowrange = years + NAm + SAm + Europe + ME + Africa + Asia + Special
  colrange = range(1,45)
  nuclear_consumption.write("title         = ASCII CSV version of Nuclear consumption data from the 2009 British Petroleum Statistical Review (worksheet 33)\n")
  nuclear_consumption.write("file URL      = http://mazamascience.com/OilExport/BP_2009_nuclear_consumption_twh.csv\n")
  nuclear_consumption.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  ...
  nuclear_consumption = open('BP_2009_nuclear_consumption_mtoe.csv','w')
  ...
  rowrange = years + NAm + SAm + Europe + ME + Africa + Asia + Special
  colrange = range(1,45)
  nuclear_consumption.write("title         = ASCII CSV version of Nuclear consumption data from the 2009 British Petroleum Statistical Review (worksheet 34)\n")
  nuclear_consumption.write("file URL      = http://mazamascience.com/OilExport/BP_2009_nuclear_consumption_mtoe.csv\n")
  nuclear_consumption.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  nuclear_consumption.write("country codes = ISO3166-1 two-letter codes or 'BP_~~~' for special groups (e.g. BP_TNA = Total North America)\n")
  ...
  hydro_consumption = open('BP_2009_hydro_consumption_twh.csv','w')
  ...
  rowrange = years + NAm + SAm + Europe + ME + Africa + Asia + Special
  colrange = range(1,45)
  hydro_consumption.write("title         = ASCII CSV version of Hydro consumption data from the 2009 British Petroleum Statistical Review (worksheet 35)\n")
  hydro_consumption.write("file URL      = http://mazamascience.com/OilExport/BP_2009_hydro_consumption_twh.csv\n")
  hydro_consumption.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  ...
  hydro_consumption = open('BP_2009_hydro_consumption_mtoe.csv','w')
  ...
  rowrange = years + NAm + SAm + Europe + ME + Africa + Asia + Special
  colrange = range(1,45)
  hydro_consumption.write("title         = ASCII CSV version of Hydro consumption data from the 2009 British Petroleum Statistical Review (worksheet 36)\n")
  hydro_consumption.write("file URL      = http://mazamascience.com/OilExport/BP_2009_hydro_consumption_mtoe.csv\n")
  hydro_consumption.write("original data = http://www.bp.com/liveassets/bp_internet/globalbp/globalbp_uk_english/reports_and_publications/statistical_energy_review_2008/STAGING/local_assets/2009_downloads/statistical_review_of_world_energy_full_report_2009.xls\n")
  hydro_consumption.write("country codes = ISO3166-1 two-letter codes or 'BP_~~~' for special groups (e.g. BP_TNA = Total North America)\n")
